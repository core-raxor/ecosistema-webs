    ...
    items: [
      {
        ...
        label: "Visibility",
        description:
          "A clear dashboard system that shows how your business is performing in real time.",
        includes: ["Custom dashboard", "KPI setup", "Visual reporting", "Performance tracking"],
        cta: "Apply",
        price: "$300–$1,000",
      },
      {
        ...
        label: "Control",
        description:
          "Financial visibility systems designed to help you understand revenue, costs and operational performance.",
        includes: [
          "Cash flow tracking",
          "Cost analysis",
          "Revenue visibility",
      ...
      },
      {
        ...
        label: "Intelligence",
        description:
          "Advanced analytics and operational intelligence systems for strategic decision-making.",
        includes: ["Data integration", "Advanced analytics", "BI systems", "Strategic insights"],
        cta: "Apply",
        price: "$8,000–$20,000",
      },
    ],
    ...
    items: [
      {
        ...
        label: "Visibility",
        description:
          "Un sistema de dashboards claro que muestra cómo está funcionando tu negocio en tiempo real.",
        includes: [
      ...
      },
      {
        ...
        label: "Control",
        description:
          "Sistemas de visibilidad financiera diseñados para entender ingresos, costos y rendimiento operativo.",
        includes: [
      ...
      },
      {
        ...
        label: "Intelligence",
        description:
          "Sistemas avanzados de analítica e inteligencia operativa para toma de decisiones estratégicas.",
        includes: [
